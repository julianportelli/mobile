...
public class bPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bPostActivity.this.setTitle("New Post");
            ...
            fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) { //delay reset of progress bar for 500ms
                            ...
                            Toast.makeText(bPostActivity.this, "Upload Successful!", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(bPostActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
